...
const en = {
  ...
  "settings.apiKeyHint":
    "The key is decrypted in memory only while the credential vault is unlocked.",
  "settings.showApiKey": "Show API key",
  "settings.hideApiKey": "Hide API key",
  "settings.save": "Save settings",
  "settings.clear": "Clear settings",
  "settings.securityTitle": "Stored securely in this browser",
  "settings.securityDescription":
    "The endpoint and API key are encrypted with your vault PIN before being saved to local storage. They are not synced to another browser or device.",
  "settings.localOnly": "Browser-local storage",
  "settings.encrypted": "AES-GCM encrypted",
...
const vi: Record<MessageKey, string> = {
  ...
  "settings.apiKeyHint":
    "Key chỉ được giải mã trong bộ nhớ khi kho credential đang được mở khóa.",
  "settings.showApiKey": "Hiện API key",
  "settings.hideApiKey": "Ẩn API key",
  "settings.save": "Lưu cài đặt",
  "settings.clear": "Xóa cài đặt",
  "settings.securityTitle": "Được lưu an toàn trong trình duyệt này",
  "settings.securityDescription":
    "Endpoint và API key được mã hóa bằng PIN của kho credential trước khi lưu vào local storage. Dữ liệu không được đồng bộ sang trình duyệt hoặc thiết bị khác.",
  "settings.localOnly": "Lưu cục bộ trong trình duyệt",
  "settings.encrypted": "Mã hóa AES-GCM",
